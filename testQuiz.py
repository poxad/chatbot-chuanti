...
def get_question():
    ...
    response = model.generate_content("Give me college level math questions...MAKE SURE TO ASK FOR A JSON WITH THE QUESTION, CHOICES, CORRECT_ANSWER, AND EXPLANATION",
